...
p_effect <- ggplot(effect_df, aes(x = pos)) +
  ...
  geom_line(aes(y=read_counts [2,]-read_counts [1,] ), color = "black", alpha=0.3)+
  geom_line(aes(y = effect), color = "navyblue", linewidth = 0.7) +
