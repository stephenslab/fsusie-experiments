...
### For PVE=20% ------
path <- getwd()
load(paste( path,"/simulation/Simulation_results/dist_decay_L_accuracy_128_sd2.RData", 
            sep=""))
...
### For PVE=30% ----- 
path <- getwd()
load(paste( path,"/simulation/Simulation_results/dist_decay_L_accuracy_128_sd3.RData", 
            sep=""))
...
### For PVE=40% ------ 
path <- getwd()
load(paste( path,"/simulation/Simulation_results/dist_decay_L_accuracy_128_sd4.RData", 
            sep=""))
...
pdf(paste0 (path, "/plot/simu_128_decay.pdf") , width = 11.69, height = 8.27)  
