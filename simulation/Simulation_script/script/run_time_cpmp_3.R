...
X <- N3finemapping$X
N=500
genotype <-X[1:N,1:1000]

library(gplots)#

if(file.exists("/home/wdenault/fsusi_simu/sim3/run_time_comp_p1000.RData")){
  load("/home/wdenault/fsusi_simu/sim3/run_time_comp_p1000.RData")
...
for (o  in (length(res)+1):10000) {
  ...
  res[[o]] <- out
  save(res, file="/home/wdenault/fsusi_simu/sim3/run_time_comp_p1000.RData")
