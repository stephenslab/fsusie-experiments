...
library(gplots)
if(file.exists("/home/wdenault/fsusi_simu/sim3/block_L_accuracy_512_sd2.RData")){
  load("/home/wdenault/fsusi_simu/sim3/block_L_accuracy_512_sd2.RData")
...
for (o  in (length(res)+1):10000) {
  ...
  for(l in 1:L){
    ...
    block_corr_generate = function(R =2^9,# # sites
  ...
  save(res, file="/home/wdenault/fsusi_simu/sim3/block_L_accuracy_512_sd2.RData")
}
