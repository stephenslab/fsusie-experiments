...
library(gplots)
if(file.exists("/home/wdenault/fsusi_simu/sim3/check_L_accuracy_sd2.RData")){
  load("/home/wdenault/fsusi_simu/sim3/check_L_accuracy_sd2.RData")
...
for (o  in (length(res)+1):10000) {
  ...
  save(res, file="/home/wdenault/fsusi_simu/sim3/check_L_accuracy_sd2.RData")
}
