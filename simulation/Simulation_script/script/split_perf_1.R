...
if(file.exists("/home/wdenault/fsusi_simu/sim3/split_perf_100.RData")){
  load("/home/wdenault/fsusi_simu/sim3/split_perf_100.RData")
...
for ( o in 1:10000){
  ...
  res[[o]] <- out
  save(res, file="/home/wdenault/fsusi_simu/sim3/split_perf_100.RData")
}
