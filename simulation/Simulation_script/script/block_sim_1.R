...
library(gplots)
if(file.exists("/home/wdenault/fsusi_simu/sim3/block_L_accuracy_sd1.RData")){
...
for (o  in (length(res)+1):10000) {
  ...
  Y <-Y+matrix(rnorm((2^5)*100 ,sd=sd(c(Y))), nrow = 100)
  ...
  save(res, file="/home/wdenault/fsusi_simu/sim3/block_L_accuracy_sd1.RData")
}
