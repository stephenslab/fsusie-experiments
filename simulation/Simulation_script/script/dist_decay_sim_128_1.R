...
library(gplots)
if(file.exists("/home/wdenault/fsusi_simu/sim3/dist_decay_L_accuracy_128_sd1.RData")){
  load("/home/wdenault/fsusi_simu/sim3/dist_decay_L_accuracy_128_sd1.RData")
...
for (o  in (length(res)+1):10000) {
  ...
  Y <-Y+matrix(rnorm((2^7)*100 ,sd=sd(c(Y))/sqrt(1)), nrow = 100)
  ...
  save(res, file="/home/wdenault/fsusi_simu/sim3/dist_decay_L_accuracy_128_sd1.RData")
}
