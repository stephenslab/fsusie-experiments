...
library(gplots)
if(file.exists("/home/wdenault/fsusi_simu/sim3/block_L_accuracy_sd3.RData")){
  load("/home/wdenault/fsusi_simu/sim3/block_L_accuracy_sd1.RData")
...
for (o  in (length(res)+1):10000) {
  ...
  for(l in 1:L){
    ...
    block_corr_generate = function(R =2^5,# # sites
  ...
  save(res, file="/home/wdenault/fsusi_simu/sim3/block_L_accuracy_sd3.RData")
}
