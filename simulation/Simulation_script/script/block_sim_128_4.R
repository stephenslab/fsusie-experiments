...
library(gplots)
if(file.exists("/home/wdenault/fsusi_simu/sim3/block_L_accuracy_128_sd4.RData")){
  load("/home/wdenault/fsusi_simu/sim3/block_L_accuracy_128_sd4.RData")
...
for (o  in (length(res)+1):10000) {
  ...
  save(res, file="/home/wdenault/fsusi_simu/sim3/block_L_accuracy_128_sd4.RData")
}
