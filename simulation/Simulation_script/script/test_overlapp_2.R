...
if(file.exists("/home/wdenault/fsusi_simu/sim3/overlap_check_distdecay_sd1.RData")){
  load("/home/wdenault/fsusi_simu/sim3/overlap_check_distdecay_sd1.RData")
...
for (o  in (length(res)+1):10000) {
  ...
  Y2 <- sigmoid(Y2)
  PCA <- svd(Y2)
  m12 <-susiF(Y=Y2, X=G,L=5  ,nullweight=10,  maxit=10)
  ### buidling zscore
