...
if(file.exists("/home/wdenault/fsusi_simu/sim3/check_L_accuracy_128_sd4.RData")){
  load("/home/wdenault/fsusi_simu/sim3/check_L_accuracy_128_sd4.RData")
...
for (o  in (length(res)+1):10000) {
  ...
  out <- c( length(m1$cs), #number of CS
            ...
            L,tt)
  res[[o]] <- unlist(out)
  save(res, file="/home/wdenault/fsusi_simu/sim3/check_L_accuracy_128_sd4.RData")
