...
if(file.exists("/home/wdenault/fsusi_simu/sim3/run_time_comp_p100.RData")){
  load("/home/wdenault/fsusi_simu/sim3/run_time_comp_p100.RData")
...
for (o  in (length(res)+1):10000) {
  ...
  res[[o]] <- out
  save(res, file="/home/wdenault/fsusi_simu/sim3/run_time_comp_p100.RData")
