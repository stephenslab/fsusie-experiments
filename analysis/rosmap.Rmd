...
Region sizes in base-pairs and SNPs. Similar but not exactly the same
to the mQTL fine-mapping regions.
...
The regions fine-mapped by fSuSiE are typically much larger than the
SuSiE fine-mapping regions. They contain thousands of SNPs spanning
several Mb:
