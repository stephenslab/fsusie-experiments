...
p1 <- region_sizes_histogram(susie$regions,susie$pips,max_size = 12e6)
...
susie_cs1snp        <- get_cs1snp(susie$cs)
fsusie_haqtl_cs1snp <- get_cs1snp(fsusie_haqtl$cs)
fsusie_mqtl_cs1snp  <- get_cs1snp(susie_mqtl$cs)
