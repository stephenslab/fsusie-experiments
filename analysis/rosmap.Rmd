...
highconf_susie <- get_highconf_snps(susie$pips,level = 0.75)
highconf_mqtl  <- get_highconf_snps(fsusie_mqtl$pips,level = 0.75)
highconf_haqtl <- get_highconf_snps(fsusie_haqtl$pips,level = 0.75)
