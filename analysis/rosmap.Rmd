...
fSuSiE fine-mapping of H3K9ac ChIP-seq and overlap with expression SNPs
-----------------------------------------------------------------------
...
```{r fsusie-haqtl-cs-sizes, fig.height=3, fig.width=3}
...
fSuSiE fine-mapping of methylation and overlap with expression SNPs
-------------------------------------------------------------------
