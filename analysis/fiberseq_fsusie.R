...
# Analysis of processed_region_data_chr1_37690171_37691171.rds.
set.seed(1)
dat <- readRDS("../data/processed_region_data_chr1_37690171_37691171.rds")
...
plot(x,colMeans(pheno[i0,]),type = "l",col = "darkblue",
     xlab = "base-pair position")
lines(x,colMeans(pheno[i1,]),type = "l",col = "orangered")
