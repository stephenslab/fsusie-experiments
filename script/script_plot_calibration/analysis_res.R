...
### For PVE=10% ---- 
path <- getwd()
load(paste( path,"/simulation/Simulation_results/check_L_accuracy_sd1.RData", 
            sep=""))
...
h <- 1
for ( i in 1:max(df_simu$Number_effect))
{
...
### For PVE=20% ------ 
path <- getwd()
load(paste( path,"/simulation/Simulation_results/check_L_accuracy_sd2.RData", 
            sep=""))
...
### For PVE=30% ----- 
path <- getwd()
load(paste( path,"/simulation/Simulation_results/check_L_accuracy_sd3.RData", 
            sep=""))
...
### For PVE=40% ------ 
path <- getwd()
load(paste( path,"/simulation/Simulation_results/check_L_accuracy_sd4.RData", 
            sep=""))
