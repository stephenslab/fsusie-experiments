...
if(file.exists("/home/wdenault/fsusi_simu/correlated_sim/short_range_512_sd4.RData")){
  load("/home/wdenault/fsusi_simu/correlated_sim/short_range_512_sd4.RData")
...
for (o  in (length(res)+1):10000) {
  ...
  save(res, file="/home/wdenault/fsusi_simu/correlated_sim/short_range_512_sd4.RData")
}
