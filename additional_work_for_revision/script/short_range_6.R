...
if(file.exists("/home/wdenault/fsusi_simu/correlated_sim/short_range_512_sd2.RData")){
  load("/home/wdenault/fsusi_simu/correlated_sim/short_range_512_sd2.RData")
...
for (o  in (length(res)+1):10000) {
  ...
  m1 <- susiF(Y=Y, X=G,L=20 ,L_start=11 ,nnullweight= 1, prior="mixture_normal", cal_obj =FALSE,  maxit=10)
  ...
  save(res, file="/home/wdenault/fsusi_simu/correlated_sim/short_range_512_sd2.RData")
}
