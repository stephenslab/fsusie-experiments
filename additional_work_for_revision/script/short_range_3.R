...
if(file.exists("/home/wdenault/fsusi_simu/correlated_sim/short_range_128_sd3.RData")){
  load("/home/wdenault/fsusi_simu/correlated_sim/short_range_128_sd3.RData")
...
for (o  in (length(res)+1):10000) {
  ...
  m1 <- susiF(Y=Y, X=G,L=20 ,L_start=11 ,nullweight= 10,
              ...
              cal_obj =FALSE,
              maxit=10)
  m2 <- susiF(Y=Y, X=G,L=20,L_start=11 ,
              prior="mixture_normal_per_scale"  ,nullweight= 10, maxit=10)
  ...
  save(res, file="/home/wdenault/fsusi_simu/correlated_sim/short_range_128_sd3.RData")
}
