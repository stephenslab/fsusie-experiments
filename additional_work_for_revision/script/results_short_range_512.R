...
path <- getwd()
load(paste( path,"/additional_work_for_revision/simulations/short_range_512_sd1.RData", 
            sep=""))
...
P1_pur  <- ggplot(df_plot, aes( x=L, y= mean_purity, col=prior))+
  ...
  #              position=position_dodge(.9) )+
  ylim(c(0.9,max(df_plot$purity_er_up)))+
...
### For PVE=20% ------
path <- getwd()
load(paste( path,"/additional_work_for_revision/simulations/short_range_512_sd2.RData", 
            sep=""))
...
### For PVE=30% ----- 
path <- getwd()
load(paste( path,"/additional_work_for_revision/simulations/short_range_512_sd3.RData", 
            sep=""))
...
### For PVE=40% ------ 
path <- getwd()
load(paste( path,"/additional_work_for_revision/simulations/short_range_512_sd4.RData", 
            sep=""))
...
pdf(paste0 (path, "/plot/simu_512_short_range.pdf") , width = 11.69, height = 8.27)  
