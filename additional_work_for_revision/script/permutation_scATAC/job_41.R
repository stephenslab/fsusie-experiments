...
result_file <- "/home/wdenault/fsusi_simu/correlated_sim/permutation_scATAC_results//result_scATAC_41.RData"
filter_ncell <- 0
...
out <- list(
  results = res_job,
  param = c(nullweight=0.500, thresh_lowcount=0.010),
  job_id = 41
)
