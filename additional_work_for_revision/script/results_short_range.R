...
path <- getwd()
load(paste( path,"/additional_work_for_revision/simulations/short_range_128_sd1.RData", 
            sep=""))
...
### For PVE=20% ------
path <- getwd()
load(paste( path,"/additional_work_for_revision/simulations/short_range_128_sd2.RData", 
            sep=""))
...
### For PVE=30% ----- 
path <- getwd()
load(paste( path,"/additional_work_for_revision/simulations/short_range_128_sd3.RData", 
            sep=""))
...
### For PVE=40% ------ 
path <- getwd()
load(paste( path,"/additional_work_for_revision/simulations/short_range_128_sd4.RData", 
            sep=""))
...
pdf(paste0 (path, "/plot/simu_128_short_range.pdf") , width = 11.69, height = 8.27)  
