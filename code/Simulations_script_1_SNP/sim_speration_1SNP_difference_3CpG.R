...
save(res, file="/project2/mstephens/fungen_xqtl/case_study/results/test_one_SNP_difference_3CPG.RData")


load("/project2/mstephens/fungen_xqtl/case_study/results/test_one_SNP_difference_3CPG.RData")
tt= list()
